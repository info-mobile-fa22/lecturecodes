document.addEventListener("DOMContentLoaded", function(event) {
	...
	document.getElementById('exercise-menu1').addEventListener('click', function(event){
		alert(document.getElementById('exercise').textContent)
	});

	document.getElementById('exercise-menu2').addEventListener('click', function(event){
		alert(document.getElementById('exercise').innerHTML)
	});

	document.getElementById('exercise-menu3').addEventListener('click', function(event){
		alert(document.getElementById('weather').getAttribute("href"))
	});
	
	document.getElementById('exercise-menu4').addEventListener('click', function(event){
		alert(document.getElementById('img-exercise').getAttribute("src"))
	});

	document.getElementById('test-menu5').addEventListener('click', function(event){
		alert(document.getElementById('button-exercise').value)
	});
